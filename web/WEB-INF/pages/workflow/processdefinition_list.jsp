  				...
  				<tr>
					...
					<script >
						function showPng(id) {
							//alert(id);
							//显示流程图
							window.open("${pageContext.request.contextPath}/processDefinition_viewpng.action?id="+id);
                        }
                        ...
                        function del(id) {
						    ...
						    $.messager.confirm("提示","是否要删除？",function (r) {
								...
								//执行删除
                                var url = "${pageContext.request.contextPath}/processDefinition_del.action";
                                $.post(url,{id:id},function (data) {

                                    if(data == "success"){
                                        $.messager.alert("提示","删除成功","info",function () {
											location.href = "${pageContext.request.contextPath}/processDefinition_list.action";
                                        });
                                    }else{
